    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
          <div class="modal-header p-5 pb-4 border-bottom-0">
            ...
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="signup-btn-close"></button>
          </div>

          <div class="modal-body p-5 pt-0">
            <form class="" @submit.prevent="signup">
              <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-3" id="new-username" placeholder="아이디" v-model="username">
                <label for="new-username">아이디</label>
              </div>
              <div class="form-floating mb-3">
                <input type="password" autoComplete="off" class="form-control rounded-3" id="new-password" placeholder="비밀번호" v-model="password1">
                <label for="new-password">비밀번호</label>
              </div>
              <div class="form-floating mb-3">
                <input type="password" autoComplete="off" class="form-control rounded-3" id="new-password-confirm" placeholder="비밀번호 확인" v-model="password2">
              ...
              <small class="text-muted">이미 가입하셨나요? </small>
              <small class="text-muted" data-bs-toggle="modal" data-bs-target="#logInModal">로그인</small>
              
              <hr class="my-4">
              <h2 class="fs-5 fw-bold mb-3">다른 계정으로 로그인하기</h2>
...
export default {
  ...
  methods: {
    async signup(){
      ...
      await this.$store.dispatch("signUp", {username, password1, password2})
      // this.username = null
      this.password1 = null
      this.password2 = null
    }
